...
urlpatterns = [
                  ...
                  path('participant/remove/<int:pk>/<int:participantid>/', StudyParticipantRemove.as_view(),
                       name="participant_remove_related"),
                  ...
                  path('sample/transform/delete/<int:pk>/', TransformSampleDelete.as_view(),
                       name="sample_transform_delete"),
                  ...
                  path('sample/harvest/delete/<int:pk>/', HarvestSampleDelete.as_view(), name="sample_harvest_delete"),
                  ...
                  path('sample/shipment/delete/<int:pk>/', ShipmentDelete.as_view(), name="sample_shipment_delete"),
                  path('sample/qc/create/<int:sampleid>/', QCCreate.as_view(), name="sample_qc_add"),
                  path('sample/qc/update/<int:pk>/', QCUpdate.as_view(), name="sample_qc_update"),
                  path('sample/qc/delete/<int:pk>/', QCDelete.as_view(), name="sample_qc_delete"),
                  ...
                  path('subsample/delete/<int:pk>/', SubSampleDelete.as_view(), name="subsample_delete"),
