...
urlpatterns = [
    ...
    path('dataset/row/create/<int:datasetid>/', datasets.DatasetRowCreate.as_view(), name='dataset_row_create'),
    path('dataset/row/create/<int:datasetid>/participant/<int:participantid>/', datasets.DatasetRowCreate.as_view(),
         name='dataset_participant_create'),
    path('dataset/participant/update/<int:pk>/', datasets.DatasetParticipantUpdate.as_view(),
         name='dataset_participant_update'),
    path('dataset/files/create/<int:datasetid>', datasets.DatasetFileCreate.as_view(), name='dataset_files_create'),
    path('dataset/files/update/<int:pk>/', datasets.DatasetFileUpdate.as_view(), name='dataset_files_update'),
    ...
    path('sample/transform/create/<int:sampleid>/', TransformSampleCreate.as_view(), name="sample_transform_add"),
    path('sample/harvest/create/<int:sampleid>/', HarvestSampleCreate.as_view(), name="sample_harvest_add"),
    path('sample/shipment/create/<int:sampleid>/', ShipmentCreate.as_view(), name="sample_shipment_add"),
    path('sample/transform/update/<int:pk>/', TransformSampleUpdate.as_view(), name="sample_transform_update"),
    ...
    path('subsample/create/<slug:sampletype>/<int:sampleid>/', SubSampleCreate.as_view(), name="subsample_add"),
    ...
    path('clinical/create/participant/<int:participantid>/', ClinicalCreate.as_view(), name="clinical_participant_create"),
    ...
    path('clinical/symptoms_hallucination/create/<int:clinicalid>/', ClinicalSymptomsHallucinationCreate.as_view(),
         name='clinical_symptoms_hallucination_create'),
    path('clinical/symptoms_hallucination/update/<int:pk>/', ClinicalSymptomsHallucinationUpdate.as_view(),
    ...
    path('clinical/symptoms_behaviour/create/<int:clinicalid>/', ClinicalSymptomsBehaviourCreate.as_view(),
    ...
    path('clinical/symptoms_depression/create/<int:clinicalid>/', ClinicalSymptomsDepressionCreate.as_view(),
