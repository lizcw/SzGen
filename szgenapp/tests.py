...
class ParticipantsPageTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.studyparticipant = StudyParticipant.objects.create(participant=cls.participant,
                                                               ...
                                                               family='123',
                                                               individual='001',
                                                               arrival_date=datetime.date(2010, 12, 6))
    ...
    def test_participant_arrival_date(self):
        self.assertEqual(self.studyparticipant.arrival_date, datetime.date(2010, 12, 6))
    ...
    def test_participant_studyparticipant(self):
        studyparticipant2 = StudyParticipant.objects.create(participant=self.participant,
                                                               ...
                                                               family='',
                                                               individual='',
                                                               arrival_date=datetime.date(2010, 12, 10))
...
class SamplesPageTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.sample = Sample.objects.create(participant=cls.studyparticipant,
                                           ...
                                           rebleed=False,
                                           storage_date=datetime.date(2009, 9, 5),
                                           storage_location=cls.loc1,
                                           notes='Test sample')
    ...
    def test_sample_transform(self):
        tfm = TransformSample.objects.create(sample=self.sample, transform_date=datetime.date(2010,12,2), failed=False, notes='Test Transform')
