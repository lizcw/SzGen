    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('PLASMA', 'Plasma'), ('SERUM', 'Serum'), ('PAXGENE', 'PAXGENE'), ('WB', 'Whole blood'), ('SALIVA', 'Saliva'), ('UNKNOWN', 'Unknown')], max_length=30)),
            ],
        ),
        migrations.CreateModel(
            name='Study',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accessid', models.CharField(blank=True, help_text='Alternative ID eg, ID from Samples Access DB', max_length=30, null=True, verbose_name='AccessDB ID')),
                ...
                ('related_participant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_participants', to='szgenapp.StudyParticipant')),
