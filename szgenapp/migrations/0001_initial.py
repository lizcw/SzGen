# Generated by Django 2.2.3 on 2019-09-01 08:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age_assessment', models.IntegerField(help_text='Age at the time of assessment', validators=[szgenapp.validators.validate_age], verbose_name='Age')),
                ...
                ('current_emp_status', models.CharField(choices=[('disabled', 'Formerly worked, no longer able (disabled)'), ('homemaker', 'Homemaker primary role'), ('never worked', 'Never worked at least 30% of time'), ('student', 'Full-time student'), ('unemployed', 'Not disabled but not working (unemployed)'), ('working', 'Working at least 30% of time'), ('unknown', 'Unknown')], help_text='Employment status (at time of assessment)', max_length=30, verbose_name='Current Employment')),
                ('employment_history', models.SmallIntegerField(choices=[(1, 'Always worked'), (2, 'Periods of unemployment not related to illness'), (3, 'Minor occupational dysfunction'), (4, 'Moderate occupational dysfunction'), (5, 'Severe occupational dysfunction'), (0, 'Unknown')], help_text='Level of occupational disability over the past 5 years', verbose_name='Past Employment')),
            ],
        ),
        migrations.CreateModel(
            name='Diagnosis',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('country', models.CharField(choices=[('INDIA', 'India'), ('AUSTRALIA', 'Australia'), ('SARAWAK', 'Sarawak')], max_length=30)),
                ...
                ('alphacode', models.CharField(blank=True, help_text='Alpha code if available', max_length=30, verbose_name='Alpha Code')),
                ('secondaryid', models.CharField(blank=True, help_text='Alternative or additional ID if available', max_length=30, verbose_name='Secondary ID')),
                ('npid', models.CharField(blank=True, help_text='NP ID if available', max_length=30, verbose_name='NeuroPsychiatric ID')),
                ('pedigree', models.ManyToManyField(blank=True, help_text='Link familial participants here', related_name='_participant_pedigree_+', to='szgenapp.Participant')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('transform_date', models.DateField(blank=True, verbose_name='Transform Date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('fullnumber', models.CharField(blank=True, help_text='Provide full number if it cannot be generated from parts', max_length=30, verbose_name='Full Number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rutgers_number', models.CharField(blank=True, help_text='Rutgers Shipment for LCLs', max_length=60)),
                ('notes', models.TextField(blank=True)),
                ('sample', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='szgenapp.Sample')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('regrow_date', models.DateField(blank=True, verbose_name='Regrow Date')),
                ('harvest_date', models.DateField(blank=True, verbose_name='Harvest Date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consensus', models.IntegerField(blank=True, choices=[(0, 'No'), (1, 'Yes (electronic)'), (2, 'Yes (hard copy only)'), (3, 'Yes (not located)'), (9, 'Unknown')], default=9)),
                ('ldps', models.IntegerField(blank=True, choices=[(0, 'No'), (1, 'Yes (electronic)'), (2, 'Yes (hard copy only)'), (3, 'Yes (not located)'), (9, 'Unknown')], default=9)),
                ('notes', models.TextField(blank=True, verbose_name='Notes')),
                ('dataset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dataset_participants', to='szgenapp.Dataset', verbose_name='Participants')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dataset_files', to='szgenapp.Dataset', verbose_name='Files')),
            ],
        ),
        migrations.CreateModel(
            name='ClinicalTest',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('diagnosis', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='clinical_test_diagnosis', to='szgenapp.Diagnosis')),
                ('participant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='clinical_test', to='szgenapp.StudyParticipant')),
            ],
        ),
        migrations.CreateModel(
            name='Clinical',
            fields=[
                ...
                ('participant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='clinical', to='szgenapp.StudyParticipant')),
                ...
                ('symptoms_mania', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='clinical_mania', to='szgenapp.SymptomsMania')),
            ],
        ),
    ]
