# Generated by Django 2.2.5 on 2019-09-29 05:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('PLASMA', 'Plasma'), ('SERUM', 'Serum'), ('PAXGENE', 'PAXgene'), ('WB', 'Whole blood'), ('SALIVA', 'Saliva'), ('UNKNOWN', 'Unknown')], max_length=30, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Study',
            fields=[
                ...
                ('precursor', models.CharField(blank=True, max_length=10, null=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('status', models.CharField(choices=[('Completed', 'Completed'), ('Ongoing', 'Ongoing'), ('Not funded', 'Not funded'), ('Omit', 'Omit')], max_length=20)),
                ('notes', models.TextField(blank=True, null=True)),
            ],
            options={
                'verbose_name': 'Study',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dup', models.IntegerField(blank=True, help_text='Duration of Untreated Psychosis (DUP): Period between onset and first treatment (in years)', null=True, verbose_name='DUP')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('severe_disorg_catatonic_behav', models.CharField(blank=True, choices=[('Nil', 'None'), ('Question', 'Question'), ('Mild', 'Mild'), ('Moderate', 'Moderate'), ('Marked', 'Marked'), ('Severe', 'Severe'), ('Unknown', 'Unknown')], help_text='Severity of current disorganised/catatonic behaviour (past 30 days)', max_length=20, null=True, verbose_name='Severity of Current Disorganised Behaviour')),
                ...
                ('affective_flattening', models.CharField(blank=True, choices=[('Nil', 'None'), ('Question', 'Question'), ('Mild', 'Mild'), ('Moderate', 'Moderate'), ('Marked', 'Marked'), ('Severe', 'Severe'), ('Unknown', 'Unknown')], help_text='Severity of current affective flattening/inappropriate affect (past 30 days)', max_length=20, null=True, verbose_name='Affective Flattening')),
                ('allogia', models.CharField(blank=True, choices=[('Nil', 'None'), ('Question', 'Question'), ('Mild', 'Mild'), ('Moderate', 'Moderate'), ('Marked', 'Marked'), ('Severe', 'Severe'), ('Unknown', 'Unknown')], help_text='Severity of current alogia/negative thought disorder (past 30 days)', max_length=20, null=True, verbose_name='Alogia')),
                ('avolition', models.CharField(blank=True, choices=[('Nil', 'None'), ('Question', 'Question'), ('Mild', 'Mild'), ('Moderate', 'Moderate'), ('Marked', 'Marked'), ('Severe', 'Severe'), ('Unknown', 'Unknown')], help_text='Severity of current avolition/apathy (past 30 days)', max_length=20, null=True, verbose_name='Avolition / Apathy')),
                ('anhedonia', models.CharField(blank=True, choices=[('Nil', 'None'), ('Question', 'Question'), ('Mild', 'Mild'), ('Moderate', 'Moderate'), ('Marked', 'Marked'), ('Severe', 'Severe'), ('Unknown', 'Unknown')], help_text='Severity of current anhedonia/asociality (past 30 days)', max_length=20, null=True, verbose_name='Anhedonia / Asociality')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sevcur_delusions', models.CharField(blank=True, choices=[('Nil', 'None'), ('Question', 'Question'), ('Mild', 'Mild'), ('Moderate', 'Moderate'), ('Marked', 'Marked'), ('Severe', 'Severe'), ('Unknown', 'Unknown')], help_text='Severity of current delusions (past 30 days)', max_length=20, null=True, verbose_name='Severity of Current Delusions')),
                ...
                ('religious_delusions', models.CharField(blank=True, choices=[('No', 'No'), ('Yes', 'Yes'), ('Cul', 'Culturally acceptable (non-delusional) beliefs'), ('Unk', 'Unknown')], help_text='Presence (lifetime) of religious delusions or delusions of magic', max_length=20, null=True, verbose_name='Religious / Magic Delusions')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('curr_gaf', models.CharField(blank=True, choices=[('Nil', '81-100 (None)'), ('Mild', '61-80 (Mild)'), ('Moderate', '31-60 (Moderate)'), ('Severe', '1-30 (Severe)'), ('Unknown', 'Unknown')], help_text='Current (past 30 days) rating on the Global Assessment of Function Scale', max_length=20, null=True, verbose_name='Current Global Assessment of Function (GAF)')),
                ('wl_gaf', models.CharField(blank=True, choices=[('Mild', '61-80 (Mild)'), ('Moderate', '31-60 (Moderate)'), ('Severe', '1-30 (Severe)'), ('Unknown', 'Unknown')], help_text='Lowest (lifetime) rating on the Global Assessment of Function Scale', max_length=20, null=True, verbose_name='Worst Lifetime Global Assessment of Function (GAF)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('severe_hallucinations', models.CharField(blank=True, choices=[('Nil', 'None'), ('Question', 'Question'), ('Mild', 'Mild'), ('Moderate', 'Moderate'), ('Marked', 'Marked'), ('Severe', 'Severe'), ('Unknown', 'Unknown')], help_text="Severity of current hallucinations (past 30 days). 'Question' category usually grouped with 'Unknown' category for analyses", max_length=20, null=True, verbose_name='Severity of Current Hallucinations')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True, null=True)),
                ('sample', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transform', to='szgenapp.Sample')),
            ],
        ),
        migrations.CreateModel(
            name='SubSample',
            fields=[
                ...
                ('sample', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subsamples', to='szgenapp.Sample')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('country', models.CharField(choices=[('AUS', 'Australia'), ('FIJ', 'Fiji'), ('IND', 'India'), ('MAL', 'Malaysia'), ('SWK', 'Sarawak'), ('UNK', 'Unknown')], help_text='Participant Country', max_length=30)),
                ('status', models.CharField(choices=[('ACTIVE', 'Active'), ('WITHDRAWN', 'Withdrawn'), ('DECEASED', 'Deceased'), ('UNKNOWN', 'Unknown')], default='ACTIVE', help_text='Participant status', max_length=20)),
                ('alphacode', models.CharField(blank=True, help_text='Alpha code if available', max_length=30, null=True, verbose_name='Alpha Code')),
                ('accessid', models.CharField(blank=True, help_text='ID from Samples Access DB', max_length=30, null=True, verbose_name='AccessDB ID')),
                ('secondaryid', models.CharField(blank=True, help_text='Alternative or additional ID if available', max_length=30, null=True, verbose_name='Secondary ID')),
                ('npid', models.CharField(blank=True, help_text='NP ID if available', max_length=30, null=True, verbose_name='NeuroPsychiatric ID')),
                ('fullnumber', models.CharField(help_text='Provide full number if it cannot be generated from parts', max_length=30, unique=True, verbose_name='Full Number')),
                ('district', models.CharField(blank=True, help_text='For CBZ study enter district(1-5)', max_length=5, null=True, verbose_name='CBZ Study District')),
                ('family', models.CharField(blank=True, help_text='Family number if available', max_length=20, null=True)),
                ('individual', models.CharField(blank=True, help_text='Individual number if available', max_length=20, null=True)),
                ('notes', models.CharField(blank=True, help_text='Notes on individual', max_length=250, null=True)),
                ('related_participant', models.ManyToManyField(related_name='_studyparticipant_related_participant_+', to='szgenapp.StudyParticipant')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True, null=True)),
                ('sample', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='shipment', to='szgenapp.Sample')),
            ],
        ),
        migrations.AddField(
            model_name='sample',
            name='participant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='samples', to='szgenapp.StudyParticipant'),
        ),
        migrations.AddField(
            model_name='sample',
            name='sample_types',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True, null=True)),
                ('sample', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sample_qc', to='szgenapp.Sample')),
            ],
        ),
        migrations.CreateModel(
            name='HarvestSample',
            fields=[
                ...
                ('notes', models.TextField(blank=True, null=True)),
                ('sample', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='harvest', to='szgenapp.Sample')),
            ],
        ),
        migrations.CreateModel(
            name='Document',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dataset_participants', to='szgenapp.Dataset')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dataset_files', to='szgenapp.Dataset')),
            ],
        ),
        migrations.AddField(
            model_name='clinical',
