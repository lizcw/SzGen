...
class Sample(models.Model):
    ...
    serum_location = models.CharField(max_length=60, verbose_name='Serum Location', blank=True, null=True,
                                help_text='Location of serum sample')
    plasma_location = models.CharField(max_length=60, verbose_name='Plasma Location', blank=True, null=True,
                                       help_text='Location of plasma sample')
