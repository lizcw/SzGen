...
class Demographic(models.Model):
    ...
    """
    id = models.AutoField(primary_key=True)
    participant = models.ForeignKey('Clinical', on_delete=models.CASCADE, related_name='demographic')
...
class Diagnosis(models.Model):
    ...
    """
    id = models.AutoField(primary_key=True)
    participant = models.ForeignKey('Clinical', on_delete=models.CASCADE, related_name='diagnosis')
    ...
    hospitalisation = models.NullBooleanField(null=True, blank=True,
    ...
    def __str__(self):
        return "%s %s" % (self.participant, self.summary)
...
class MedicalHistory(models.Model):
    ...
    """
    id = models.AutoField(primary_key=True)
    participant = models.ForeignKey('Clinical', on_delete=models.CASCADE, related_name='medical')
...
class SymptomsGeneral(models.Model):
    ...
    """
    id = models.AutoField(primary_key=True)
    participant = models.ForeignKey('Clinical', on_delete=models.CASCADE, related_name='symptoms_general')
...
class SymptomsDelusion(models.Model):
    ...
    """
    id = models.AutoField(primary_key=True)
    participant = models.ForeignKey('Clinical', on_delete=models.CASCADE, related_name='symptoms_delusion')
...
class SymptomsHallucination(models.Model):
    ...
    """
    id = models.AutoField(primary_key=True)
    participant = models.ForeignKey('Clinical', on_delete=models.CASCADE, related_name='symptoms_hallucination')
...
class SymptomsBehaviour(models.Model):
    ...
    """
    id = models.AutoField(primary_key=True)
    participant = models.ForeignKey('Clinical', on_delete=models.CASCADE, related_name='symptoms_behaviour')
...
class SymptomsDepression(models.Model):
    ...
    """
    id = models.AutoField(primary_key=True)
    participant = models.ForeignKey('Clinical', on_delete=models.CASCADE, related_name='symptoms_depression')
